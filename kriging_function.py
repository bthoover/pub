###########################################################################################
#
# KRIG_FLD , KRIG_VAR , HAN1_APCP = KRIG_INNOVATIONS(
#                                                     STAT_PRCP_QCd ,
#                                                     BKG_PRCP_QCd  ,
#                                                     STAT_LAT_QCd  ,
#                                                     STAT_LON_QCd  ,
...
# GRID_LATS, GRID_LONS. GRID_BKG_APCP is used as an external drift variable.
#
...
# into numpy arrays.
#
# In this formulation, we retain the ordinary kriging method (stationary mean,
# kriged field reverts to mean value if < 15 observations nearby)
#
#    INPUTS:
...
def KRIG_INNOVATIONS(
    ...
    rpy2.robjects.r('''
      ...
      project_var <- function(s4_frame,s4_grid_frame,variofit) {
          lzn.kriged <- krige(obs ~ 1, s4_frame, s4_grid_frame, model=variofit)
          return(lzn.kriged)
       }
    ''')
    #
    ...
    # Return
    #
    return KRIG_FLD , KRIG_VAR , HAN1_APCP , EMP_VARIO_PAIRS , EMP_VARIO_DISTS , \
           EMP_VARIO_GAMMA , FIT_VARIO_GAMMA , FIT_VARIO_NUGGE
#
###########################################################################################
